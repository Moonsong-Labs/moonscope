...
import { TableData, TestData } from "../../types";
...
export default ({
	...
	const toggleDirection = (current: "asc" | "desc") =>
				...
				<table class="table table-xs">
					<thead>
						<tr>
							<th>
								<a
									href={`/${reportType}?sort=id&direction=${
										sort === "id" ? toggleDirection(direction) : "asc"
									}`}
								>
									ID
								</a>
							...
							<th>
								<a href={`/${reportType}?sort=moonwall_env`}>
